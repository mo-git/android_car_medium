...
public class PreferenceUtils {
	...
	public static void clearPreference(Context context,final SharedPreferences sp) {
		final Editor editor = sp.edit();
		editor.clear();
		editor.commit();
	}

	public static boolean removeKey(Context context,SharedPreferences sp,String key){
